...
const DEFAULTS = {
  ...
  backgroundImage:
    'https://images.stockcake.com/public/b/6/8/b6881464-6a5e-42a2-8f56-d8ca35ab0268/mechanic-at-work-stockcake.jpg',
};
...
export default function Hero() {
  ...
  const rawFeatures = hero?.features?.length
    ? hero.features
    : ['Same-day servicing', 'All makes & models', 'Warranty protected'];

  const features = rawFeatures.map((featureTitle: string, index: number) => ({
    title: featureTitle,
