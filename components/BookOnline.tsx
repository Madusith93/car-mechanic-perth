          ...
          <div className="lg:col-span-7 bg-white border border-slate-200/90 p-6 sm:p-8 lg:p-10 rounded-2xl shadow-xl shadow-slate-200/50 space-y-6">
            {status === 'success' ? (
              <div className="flex flex-col items-center text-center gap-3 py-10">
                <div className="w-14 h-14 rounded-full bg-[#FF6B00]/10 border-2 border-[#FF6B00]/30 flex items-center justify-center">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                {status === 'error' && (
                  <div className="bg-red-50 border border-red-200 text-red-600 text-xs sm:text-sm rounded-xl px-4 py-3 font-medium">
                    {errorMessage}
                  </div>
                )}
